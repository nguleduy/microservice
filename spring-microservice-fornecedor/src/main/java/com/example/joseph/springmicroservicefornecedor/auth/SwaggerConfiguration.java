package com.example.joseph.springmicroservicefornecedor.auth;
...
public class SwaggerConfiguration {
  ...
  public Docket forumApi() {
    return new Docket(DocumentationType.SWAGGER_2)
            .select()
            .apis(RequestHandlerSelectors.basePackage("com.example.joseph.microservicefornecedor.controller"))
