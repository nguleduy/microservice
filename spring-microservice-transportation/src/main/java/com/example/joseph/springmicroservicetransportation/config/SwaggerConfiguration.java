package com.example.joseph.springmicroservicetransportation.config;
...
public class SwaggerConfiguration {
  ...
  public Docket forumApi() {
    return new Docket(DocumentationType.SWAGGER_2)
            .select()
            .apis(RequestHandlerSelectors.basePackage("com.example.joseph.microservicetransportation.controller"))
  ...
  private ApiInfo apiInfo() {
    return new ApiInfoBuilder()
            .title("Spring Microservice - Transportation API")
